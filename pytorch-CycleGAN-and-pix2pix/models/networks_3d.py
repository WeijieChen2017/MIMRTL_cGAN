...
class UnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, ngf=64, norm_layer=nn.BatchNorm3d, use_dropout=False):
        ...
        for i in range(num_downs - 9):          # add intermediate layers with ngf * 8 filters
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None,
        ...
        if outermost:
            upconv = nn.ConvTranspose3d(inner_nc * 2, outer_nc,
                                        ...
                                        padding=1)
            down = [downconv]
            final_layer = nn.Conv3d(outer_nc, outer_nc, kernel_size=1,
                                    stride=0, padding=0, bias=use_bias)
            up = [uprelu, upconv, final_layer]
